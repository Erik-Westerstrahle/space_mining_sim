...
//    }
 ...
 // Method to assign a miner to the ship
// public static void assignMinerToShip(Astronauts astronaut, ship_stats shipStats_instance) {
//     if (assignedMiner != null) {
//         System.out.println("A miner is already assigned: " + assignedMiner.getName() + ". Unassign the current miner before assigning a new one.");
//         // Debug: Log the currently assigned miner
//         System.out.println("DEBUG: Current assigned miner: " + assignedMiner.getName());
//         return;
//     }
//
//     System.out.println(astronaut);
//     // Debug: Log the astronaut being assigned
//     System.out.println("DEBUG: Assigning astronaut as miner: " + astronaut.getName());
//
//     assignedMiner = astronaut;
//     shipStats_instance.setMinerSkillValue(astronaut.getMinerSkillAstronautsClass());
